                ...
                <table class="data-table table nowrap">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>arkohaddoebenezer21@gmail</td>
                            <td>0572945773</td>
                            <td>
                                <div class="progress">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <a class="dropdown-item" href="#"><i class="dw dw-down-arrow"></i> Demote to
                                            previous stage</a>
                                        <a class="dropdown-item" href="#"><i class="dw dw-unlock1"></i> Suspend
                                            applicant</a>
                                        <a class="dropdown-item" href="#"><i class="icon-copy fi-x"></i> Dismiss
                                            applicant</a>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        ...
                                        <a class="dropdown-item" href="#"><i class="dw dw-unlock1"></i> Suspend
                                            applicant</a>
                                        <a class="dropdown-item" href="#"><i class="dw dw-delete"></i> Dismiss
                                            applicant</a>
                                    </div>
                                </div>
                            </td>
